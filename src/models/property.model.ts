...
export interface IProperty extends Document {
  ...
  // ──────────────────────────────────────────────────────────────────
  // Booking.com scraper fields.
  //
  // Not part of the DBMS Property schema above — these are owned by this
  // service (trust scheduler, credentials sync, cookie storage) and are
  // preserved here so that switching to the DBMS schema does not break
  // the existing Booking.com flows.
  // ──────────────────────────────────────────────────────────────────
...
const PropertySchema = new Schema<IProperty>(
  {
    ...
    // Booking.com scraper fields (see IProperty for why these live here)
    ...
    booking_last_login: { type: Date, required: false },
  },
  {
...
// Booking.com scraper indexes (trust scheduling)
