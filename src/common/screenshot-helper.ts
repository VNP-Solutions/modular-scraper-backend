...
export class ScreenshotHelper {
  ...
  /**
   * Take a screenshot, upload to S3, and save the URL to the job or retrieval record.
   *
   * @param page        Puppeteer Page instance
   * @param entityId    Job ID or Retrieval ID — used for S3 path and DB update
   ...
   * @param entityType  "job" or "retrieval" — determines which DB record to update
  ...
  public static async takeScreenshot(
    ...
    try {
      ...
      if (s3Url) {
        ...
        // Persist URL in the correct DB record
