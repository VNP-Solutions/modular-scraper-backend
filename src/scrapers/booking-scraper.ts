...
export class BookingScraper extends BaseScraper {
  ...
  /**
   * Extract the obscured recipient email hint (e.g. "e***@e***.com") shown on
   * Booking's "Check your inbox" confirmation page, so the correct password
   * reset email can be matched by recipient when multiple properties share
   * the same Gmail inbox for forgot-password recovery.
   */
